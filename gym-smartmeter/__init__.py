...
register(
    id='smartmeter-v0',
    entry_point='gymnasium.envs.SMenvs.smenv_gym:SmartMeterEnv',
)

register(
    id='smartmeter-v1',
    entry_point='gymnasium.envs.SMenvs.smenv_gym_box:SmartMeterBoxEnv',
)

register(
    id='smartmeter-v2',
    entry_point='gymnasium.envs.SMenvs.smenv_gym_continuous:SmartMeterContinuousEnv',
)
