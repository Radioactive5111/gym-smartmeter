...
class SmartMeterEnv(gym.Env):
    ...
    def reset(self,seed=None, options=None):
        ...
        info={}
        return {
                   "load level": int(self.origin_values[0]),  # Load level
    ...
    def step(self, action_index):
        ...
        if self.is_illegal_action(action_index):
            ...
            # reward_from_illegal_action = -abs(action-action_from_agent)
            ...
            if self.origin_values[self.current_step] >= max(threshold, 500):
                ...
                # Not hiding peaks
                    ...
                    reward_privacy = -50 - 0.05 * \
                                     (self.masked_values[self.current_step] - threshold)
